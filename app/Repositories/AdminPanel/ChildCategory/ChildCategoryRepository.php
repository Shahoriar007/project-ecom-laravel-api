...
namespace App\Repositories\AdminPanel\ChildCategory;
        ...
        try {
            ...
            return  DB::transaction(function () use ($validated, $request) {
                ...
                if ($request->hasFile('image')) {
                    $model->addMediaFromRequest('image')->toMediaCollection('child_category_image');
                }
        ...
        try {
            ...
            DB::transaction(function () use ($model, $request, $validated) {
                if ($request->hasFile('image')) {
                    ...
                    $model->clearMediaCollection('child_category_image');
                    $model->addMediaFromRequest('image')->toMediaCollection('child_category_image');
                }
                $model->update([
                    ...$validated,
